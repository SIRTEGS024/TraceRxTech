...
const ProcessorPage = () => {
  return (
    <>
      ...
      />
      <TailoredCardSection
        tailoredCards={TAILORED_CARDS_DATA.processSection}
        title={SECTION_HEADERS.maximize.title}
        subTitle={SECTION_HEADERS.maximize.subTitle}
        size={FONT.size.medium}
        color={FONT.color.dark}
      />
      <ChooseSection
        cardData={CHOOSE_SECTION.processSection}
        title={SECTION_HEADERS.choose.title}
      />
      <TestimonialCarousel
        textImageCarousel={TEXT_IMAGE_CAROUSEL.processSection}
        title={SECTION_HEADERS.trust.title}
        size={FONT.size.medium}
        color={FONT.color.dark}
      />
      <BlueSection {...BLUE_SECTION.processSection} />
    </>
  );
};
